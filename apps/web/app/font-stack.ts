...
// next/font shares hashed URLs between CSS and the Slovenian preload.
...
export const fontStack = `${slovenian.style.fontFamily}, ${latin.style.fontFamily}, "Posvoji Inter", "Posvoji Inter Fallback"`;
