...
export const PHOTO_BADGE_CLASS =
  "absolute right-1.5 bottom-1.5 h-5 bg-background/90 px-1.5 text-2xs tabular-nums shadow-xs desktop-box:bottom-5 phone-shell:border-foreground/10 phone-shell:bg-foreground/90 phone-shell:text-background";
