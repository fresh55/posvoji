  ...
  sl: {
    ...
    rules: [
      ...
      },
      {
        ...
        body: "Za ogled ne potrebuješ računa. Na strani ni oglasov ali sledilcev. Če dovoliš uporabo lokacije, jo uporabimo za prikaz živali po bližini in je ne shranimo. Kraj, ki ga izbereš v iskalniku zavetišč, si zapomni le tvoj brskalnik, da ga ob naslednjem obisku ni treba vpisati znova. Podatkov zasebnih lastnikov, posvojiteljev ali prosilcev ne zbiramo in ne objavljamo.",
      },
      {
        key: "exit",
