...
export function FilterSidebar({
  ...
  return (
    ...
    >
      {/* h-9 to match the results row across the gutter, which states the same
          height for itself (min-h-9 in animal-filters.tsx, the sort trigger's
          own height). The toolbar that
      ...
      <h2 className="flex h-9 items-center gap-2 text-sm font-medium">
        {messages.filters}
        {activeValues > 0 && (
