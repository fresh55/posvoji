...
export function FoundAnimalAtlas({
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[24rem_minmax(0,1fr)] lg:items-start lg:gap-column-gap">
      ...
      {/* Outside the boundary below, and that is the point of it: the finder
          holds the phone number and the guidance, and a throw inside the map
          used to take the route's whole tree with it, because this app had no
          boundary anywhere and the nearest one was Next's error page.

          The fallback is null. Losing the picture of the answer costs a
          reader the ring; losing the answer costs them the call. */}
