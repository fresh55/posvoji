 ...
 * under it that says how much of the list is on the page. Written once
 * because two grids draw it, the home page's and a shelter's own, and the
 * promise under the button has to be kept in the same words on both.
 *
