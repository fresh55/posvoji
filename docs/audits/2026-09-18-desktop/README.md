...
**Implementation progress, 18 September:** the first batch addresses D02, U1, D03, D04, D05 and D07 on an isolated branch based on `f2b7a79`. See [implemented behavior, browser evidence and passing checks](implementation/README.md). The remaining findings retain the decisions below.
